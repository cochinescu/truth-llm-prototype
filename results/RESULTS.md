...
| --- | ---: | ---: | ---: |
| full_layer | 0.2202 | 0.2067 | 0.3087 |
| bare_baseline | 0.0038 | 0.0037 | 0.0048 |
| added_per_conversation | 0.2164 | — | — |
...
Full parameter register: `run_meta.json` · protocol: `../PROTOCOL.md` · wall time 54.32s.
